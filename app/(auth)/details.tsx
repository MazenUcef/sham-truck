    ...
    <View style={{ backgroundColor: "#F9844A", flex: 1, paddingTop: 84 }}>
      <View style={{ flex: 1 }}>
        <View style={{ marginBottom: 40, flexDirection: "row", marginLeft: 24, gap: 90 }}>
          ...
          <ThemedText style={{ fontWeight: 700, fontSize: 18, lineHeight: 24, color: "white" }}>
            استعادة كلمة المرور
          </ThemedText>
        </View>

        <View style={{ flex: 1, backgroundColor: "white", padding: 20, borderTopLeftRadius: 16, borderTopRightRadius: 16 }}>
          <ThemedText style={{ fontWeight: 500, fontSize: 16, lineHeight: 25, alignSelf: "flex-end" }}>يمكنك استعادة كلمة المرور دائما</ThemedText>
          <ThemedText style={{ fontWeight: 600, fontSize: 12, color: "#878A8E", alignSelf: "flex-end", marginTop: 5, marginBottom: 24 }}>يرجى ادخال بريدك الالكتروني لارسال رابط الاستعادة</ThemedText>
